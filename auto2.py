...
def SeparazioneFile(path, file):
    ...
    estensione = estensione[1:]  # Rimuove il punto dall'estensione
    mappaEstensioni = {
        "Foto": {"estensioni": ["jpg", "png", "gif"], "icona": r"C:\Users\galloni\Downloads\Foto\foto.ico"},
        "Video": {"estensioni": ["mp4", "avi", "mov"], "icona": r"C:\Users\galloni\Downloads\Altro\rto.ico"},
        "Documenti": {"estensioni": ["doc", "docx", "pdf", "txt", "tex"], "icona": r"C:\Users\galloni\Downloads\Altro\rto.ico"},
        "Excel": {"estensioni": ["xls", "xlsx", "csv"], "icona": r"C:\Users\galloni\Downloads\Altro\rto.ico"},
        "Presentazioni": {"estensioni": ["ppt", "pptx"], "icona": r"C:\Users\galloni\Downloads\Altro\rto.ico"},
        "Aspen": {"estensioni": ["apwz", "apw"], "icona": r"C:\Users\galloni\Downloads\Altro\rto.ico"},
        "AutoCAD": {"estensioni": ["dwg", "dxf"], "icona": r"C:\Users\galloni\Downloads\Altro\rto.ico"},
        "Altro": {"estensioni": [], "icona": r"C:\Users\galloni\Downloads\Altro\RTO_AB.ico"}
    }
    for cartella, dati in mappaEstensioni.items():
